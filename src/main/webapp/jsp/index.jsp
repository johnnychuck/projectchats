...
<html>
  ...
  <nav class="navbar navbar-default navbar-fixed-top navbar-inverse" role="navigation">
		<div class="navbar-header">
			 ...
			 <a class="navbar-brand" href="#">超哥通讯后台管理</a>
		</div>
			...
			<div class="panel-group" id="grouplist">
				<div class="panel panel-default">
					<div class="panel-heading">
						 ...
						 <span class="glyphicon glyphicon-chevron-right"></span> 比尔吉沃特王者组</a>
					</div>
					<div id="panel-element-594051" class="panel-collapse collapse">
						<div class="panel-body" style="padding: 0px;">
							<ul class="nav nav-pills nav-stacked">
								<li><a href="#" style="padding-left: 20%;"><span class="glyphicon glyphicon-user"></span> 德玛西亚之力</a></li>
								<li><a href="#" style="padding-left: 20%;"><span class="glyphicon glyphicon-user"></span> 诺克萨斯之手</a></li>
								<li><a href="#" style="padding-left: 20%;"><span class="glyphicon glyphicon-user"></span> 堕落天使</a></li>
							</ul>
						</div>
					</div>
				</div>
				<div class="panel panel-default">
					<div class="panel-heading">
						 ...
						 <span class="glyphicon glyphicon-chevron-right"></span> 比尔吉沃特青铜组</a>
					</div>
					<div id="panel-element-266764" class="panel-collapse collapse">
						<div class="panel-body" style="padding: 0px;">
							<ul class="nav nav-pills nav-stacked">
								<li><a href="#" style="padding-left: 20%;"><span class="glyphicon glyphicon-user"></span> 皮城女警</a></li>
								<li><a href="#" style="padding-left: 20%;"><span class="glyphicon glyphicon-user"></span> 赏金猎人</a></li>
								<li><a href="#" style="padding-left: 20%;"><span class="glyphicon glyphicon-user"></span> 惩戒之箭</a></li>
							</ul>
						</div>
					</div>
				</div>
